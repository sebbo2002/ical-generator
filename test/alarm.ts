...
describe('ical-generator Alarm', function () {
    ...
    describe('trigger()', function () {
        ...
        it('should change something', function () {
            ...
            assert.ok(
                a
                    .toString()
                    .includes('TRIGGER;VALUE=DATE-TIME:20150201T133845Z'),
            );
        });
    });
    ...
    describe('triggerAfter()', function () {
        ...
        it('should change something', function () {
            ...
            assert.ok(
                a
                    .toString()
                    .indexOf('TRIGGER;VALUE=DATE-TIME:20150201T133845Z') > -1,
            );
        });
    });
    ...
    describe('repeat()', function () {
        ...
        it('getter should return value', function () {
            ...
            a.repeat({ interval: 60, times: 4 });
            assert.deepStrictEqual(a.repeat(), { interval: 60, times: 4 });
        });
        ...
        it('should change something', function () {
            ...
            assert.ok(
                a
                    .toString()
                    .indexOf(
                        '\r\nATTACH;VALUE=URI:https://example.com/beep.aud',
                    ) > -1,
            );
            ...
            assert.ok(
                a
                    .toString()
                    .indexOf(
                        '\r\nATTACH;FMTTYPE=audio/basic:https://example.com/beep.aud',
                    ) > -1,
            );
        });
    });
    ...
    describe('summary()', function () {
        ...
        it('should fallback to event summary', function () {
            const a = new ICalAlarm(
                { type: ICalAlarmType.email },
                new ICalEvent(
                    { start: new Date(), summary: 'Example Event' },
                    new ICalCalendar(),
                ),
            );
    ...
    describe('createAttendee()', function () {
        ...
        it('should return a ICalAttendee instance', function () {
            ...
            assert.ok(
                alarm.createAttendee({ email: 'mail@example.com' }) instanceof
                    ICalAttendee,
            );
        ...
        it('should accept object', function () {
            ...
            const attendee = alarm.createAttendee({
            ...
            assert.ok(
                alarm
                    .toString()
                    .includes(
                        'ATTENDEE;ROLE=REQ-PARTICIPANT;CN="Zac":MAILTO:zac@example.com',
                    ),
            );
        });
    });
