...
describe('ical-generator-edtex Cases', function() {
    it('case #1', function() {
    ...
    it('case #3', function() {
        const cal = ical({domain: 'sebbo.net', method: 'add', prodId: '//sebbo.net//ical-generator-edtex.tests//EN'});
        cal.createEvent({
            id: '123',
            start: new Date('Fr Oct 04 2013 22:39:30 UTC'),
    ...
    it('case #9 (organizer with mailto)', function() {
        const cal = ical({domain: 'sebbo.net', method: 'request', prodId: '//sebbo.net//ical-generator-edtex.tests//EN'});
        cal.createEvent({
            id: '123',
            start: new Date('Fr Oct 04 2013 22:39:30 UTC'),
            end: new Date('Fr Oct 04 2013 23:15:00 UTC'),
